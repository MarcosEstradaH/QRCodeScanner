class f {
  ...
  static listCameras(a = !1) {
    ...
    return (a
      ...
      .finally(() => {
        if (b) for (let a of b.getTracks()) a.stop(), b.removeTrack(a);
      });
  }
  constructor(
    a,
  ...
  static scanImage(a, b = null, c = null, d = null, g = !1, h = !1) {
    let k = c instanceof Worker,
      l = Promise.all([c || f.createQrEngine(), f._loadImage(a)]).then(
        ([a, h]) => {
          c = a;
          let l;
          [d, l] = this._drawToCanvas(h, b, d, g);
          return c instanceof Worker
            ? (k || c.postMessage({ type: "inversionMode", data: "both" }),
              new Promise((a, b) => {
                let g, h, k;
                h = (d) => {
    ...
    requestAnimationFrame(() => {
      1 >= this.$video.readyState
        ...
        : this._qrEnginePromise
            .then((a) =>
              f.scanImage(this.$video, this._scanRegion, a, this.$canvas)
            )
  ...
  _getCameraStream() {
    ...
    return [
      ...b.map((b) =>
        Object.assign({}, b, { [a]: { exact: this._preferredCamera } })
      ),
      ...b
    ].reduceRight(
      (a, b) => () =>
  ...
  static _drawToCanvas(a, b = null, c = null, d = !1) {
    ...
    d ||
      ((d = b && b.downScaledWidth ? b.downScaledWidth : k),
